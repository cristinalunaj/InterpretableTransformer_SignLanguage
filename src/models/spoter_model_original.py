"""
Code from the paper of Sign Pose-based Transformer for Word-level Sign Language Recognition (https://openaccess.thecvf.com/content/WACV2022W/HADCV/html/Bohacek_Sign_Pose-Based_Transformer_for_Word-Level_Sign_Language_Recognition_WACVW_2022_paper.html)
paper. Repository:
"""
...
class SPOTER(nn.Module):
    ...
    def __init__(self, num_classes, hidden_dim=55, n_heads=9):
        super().__init__()
...
class SPOTERnoPE(nn.Module):
    """
    Implementation of the SPOTER (Sign POse-based TransformER) architecture for sign language recognition from sequence
    of skeletal data WITHOUT THEIR 'POSITIONAL ENCODING' (self.pos removed compared to class SPOTER)
    """
